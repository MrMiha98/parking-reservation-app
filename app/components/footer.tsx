  ...
  return (
    <footer className="w-full py-10">
      <div className="mx-auto px-4 sm:px-6 max-w-3xl flex justify-between">
        <Link href="https://github.com/MrMiha98/parking-reservation-app" target="_blank" className="flex flex-row items-center gap-x-2 cursor-pointer">
        ...
        <div className="flex flex-row items-center gap-x-2 cursor-pointer">
          ...
          <Link href="https://vercel.com" target="_blank" className="flex flex-row items-center gap-x-2">
